...
char* serial_number; 	 						// store device ID and append it to message
...
int main(int argc, char** argv)
{
	...
	ROS_INFO("Initializing rft_sensor_serial Node");
	ros::NodeHandle nh;
	...
	// usleep(100);
	// serial_number = RFT_SENSOR.m_RFT_IF_PACKET.m_rcvd_serial_number;
	// ROS_INFO("Device ID: %s", serial_number);
